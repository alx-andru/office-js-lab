...
var AppComponent = (function () {
    function AppComponent() {
        this.name = 'Angular 5.1';
        this.eventHandlers = [];
        this.addEventHandler();
    }
    AppComponent.prototype.addEventHandler = function () {
        var _this = this;
        ...
        this.tryCatch(function () {
            return Excel.run(function (context) { return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
                var workbook, handler;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            workbook = context.workbook;
                            handler = workbook.onSelectionChanged.add(function () { return __awaiter(_this, void 0, void 0, function () {
                                var range;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                            ...
                            this.eventHandlers.push({ workbook: workbook, handler: handler });
                            return [4 /*yield*/, context.sync()];
                        case 1:
                            _a.sent();
                            console.log('Event handler added', 'Try changing the selection, and watch the console output.');
                            return [2 /*return*/];
                    }
                });
            }); });
    ...
    AppComponent.prototype.removeLastEventHandler = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var lastEventHandler, workbook;
            return __generator(this, function (_a) {
                lastEventHandler = this.eventHandlers.pop();
                if (!lastEventHandler) {
                    console.log('No event handlers added');
                    return [2 /*return*/];
                }
                workbook = lastEventHandler.workbook;
                this.tryCatch(function () {
                    return Excel.run(workbook, function (context) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
    ...
    AppComponent.prototype.removeAllEventHandlers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                ...
                this.tryCatch(function () { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    var _loop_1, this_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _loop_1 = function () {
                                    var lastEventHandler;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                lastEventHandler = this_1.eventHandlers.pop();
                                                return [4 /*yield*/, Excel.run(lastEventHandler.workbook, function (context) { return __awaiter(_this, void 0, void 0, function () {
                                                        return __generator(this, function (_a) {
                                                            switch (_a.label) {
                                                                case 0:
                                                                    lastEventHandler.handler.remove();
                                ...
                                _a.label = 1;
                            case 1:
                                if (!(this.eventHandlers.length > 0)) return [3 /*break*/, 3];
    ...
    AppComponent.prototype.tryCatch = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* NgModule */])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_4__hello_component__["a" /* HelloComponent */]],
...
Office.initialize = function (reason) {
    console.log('init office done, now bootstrap');
